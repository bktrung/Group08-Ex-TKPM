<template>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header bg-primary text-white">
            <h5 class="mb-0">Import / Export Dữ Liệu Sinh Viên</h5>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6 border-end">
                <h6 class="mb-3">Export Dữ Liệu</h6>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Kết Quả Import</h5>
    ...
    <div class="modal fade" id="importHelpModal" tabindex="-1" aria-hidden="true" ref="helpModalRef">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Hướng dẫn Import Dữ Liệu</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <h6>Cấu trúc tệp CSV</h6>
            <p>Tệp CSV cần có các cột sau:</p>
  ...
  23456788,Nguyen Van C,2004-01-01,Nam,Khoa Công nghệ Thông tin,2022,Kỹ thuật Phần mềm,425/23 Thu KHoa Huan,Springfield,City of Belfast,Northern Ireland,United Kingdom,nguyenvanc@test.com,0987654356,Đang học,CCCD,038204012567,2018-02-03,Cong An Phuong,2030-03-02,true,Moroccan
            ...
            <h6 class="mt-3">Cấu trúc tệp JSON</h6>
            <p>Tệp JSON cần có cấu trúc sau:</p>
            <pre class="bg-light p-2">
  {
      "studentId": "22000001",
      ...
      "mailingAddress": {
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
            <button @click="downloadTemplate" class="btn btn-primary">Tải mẫu</button>
          </div>
        </div>
      </div>
    </div>
